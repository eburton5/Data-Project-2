...
TextureCoords1_path = [pwd '/results/Clement/cPComposedLAST/FeatureFixOff/TextureCoords1/'];
TextureCoords2_path = [pwd '/results/Clement/cPComposedLAST/FeatureFixOff/TextureCoords2/'];
